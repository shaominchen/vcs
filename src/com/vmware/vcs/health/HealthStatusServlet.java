...
import com.vmware.vcs.health.VimHealthProvider.VimHealth;

/**
 * <code>HealthStatusServlet</code> generates the XML document that describe the
 * health of the solution. Queries the set of HealthProviders for status and
...
public class HealthStatusServlet extends HttpServlet {
    ...
    */
   private final String EXTENSION_NAME = "VCS Solution";
